...
FixWallSRDPol::FixWallSRDPol(LAMMPS *lmp, int narg, char **arg) :
...
double FixWallSRDPol::compute_array(int i, int j)
{
...
void FixWallSRDPol::wall_params(int flag)
{
  double xnew;
