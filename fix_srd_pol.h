...
#ifdef FIX_CLASS
// clang-format off
FixStyle(srd_pol,FixSRDPol);
// clang-format on
#else

#ifndef LMP_FIX_SRD_POL_H
#define LMP_FIX_SRD_POL_H

#include "fix.h"

namespace LAMMPS_NS {

class FixSRDPol : public Fix {
 public:
  FixSRDPol(class LAMMPS *, int, char **);
  ~FixSRDPol() override;
